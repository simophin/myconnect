...
mixin _$Device {
 ...
 String get deviceId; String get deviceName;@JsonKey(unknownEnumValue: DeviceType.unknown) DeviceType get deviceType; int get protocolVersion; List<String> get incomingCapabilities; List<String> get outgoingCapabilities;@JsonKey(unknownEnumValue: DeviceReachability.unknown) DeviceReachability get reachability; bool get paired; bool get pairing; int get lastSeenAt;
...
int get hashCode {
  final _this = this as Device;
  return Object.hash(runtimeType,_this.deviceId,_this.deviceName,_this.deviceType,_this.protocolVersion,const DeepCollectionEquality().hash(_this.incomingCapabilities),const DeepCollectionEquality().hash(_this.outgoingCapabilities),_this.reachability,_this.paired,_this.pairing,_this.lastSeenAt);
}
...
/// Create a copy of Device
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? deviceId = null,Object? deviceName = null,Object? deviceType = null,Object? protocolVersion = null,Object? incomingCapabilities = null,Object? outgoingCapabilities = null,Object? reachability = null,Object? paired = null,Object? pairing = null,Object? lastSeenAt = null,}) {
  return _then(Device(
...
switch (_that) {
case _Device() when $default != null:
return $default(_that.deviceId,_that.deviceName,_that.deviceType,_that.protocolVersion,_that.incomingCapabilities,_that.outgoingCapabilities,_that.reachability,_that.paired,_that.pairing,_that.lastSeenAt);case _:
  return orElse();
...
@override
int get hashCode {
    return Object.hash(runtimeType,deviceId,deviceName,deviceType,protocolVersion,const DeepCollectionEquality().hash(_incomingCapabilities),const DeepCollectionEquality().hash(_outgoingCapabilities),reachability,paired,pairing,lastSeenAt);
}

@override
String toString() {
    return 'Device(deviceId: $deviceId, deviceName: $deviceName, deviceType: $deviceType, protocolVersion: $protocolVersion, incomingCapabilities: $incomingCapabilities, outgoingCapabilities: $outgoingCapabilities, reachability: $reachability, paired: $paired, pairing: $pairing, lastSeenAt: $lastSeenAt)';
}
...
/// Create a copy of Device
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? deviceId = null,Object? deviceName = null,Object? deviceType = null,Object? protocolVersion = null,Object? incomingCapabilities = null,Object? outgoingCapabilities = null,Object? reachability = null,Object? paired = null,Object? pairing = null,Object? lastSeenAt = null,}) {
